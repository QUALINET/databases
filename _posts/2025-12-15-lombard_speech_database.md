---
title: Lombard Speech Database for German Language
database: Lombard Speech Database
categories:
- audio
author: Michał Sołoducha, Alexander Raake (Technische Universität Ilmenau), Frank Kettler (HEAD acoustics GmbH), Peter Voigt (AVM GmbH)
external_link: https://github.com/Telecommunication-Telemedia-Assessment/Lombard-Speech-database
access: Openly available for download from Zenodo (761.7 MB main file, 176.0 GB total)
publicly_available: true
doi: 10.5281/zenodo.48713
citation: 'Sołoducha, M., Raake, A., Kettler, F., & Voigt, P. (2016). Lombard speech database for German language. In Proceedings of DAGA 2016, Aachen.'
...
The database is openly available on Zenodo under Creative Commons Attribution 4.0 International License.
