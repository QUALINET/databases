*If you want to add a new database, please edit this post and fill out the following info. Please keep the `yaml` marker intact and only replace the values.*
